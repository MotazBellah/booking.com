...
# https://www.booking.com/searchresults.html?label=gen173nr-1FCAQoggJCDGNpdHlfLTI5MDI2M0gBWARoQ4gBAZgBAbgBF8gBDNgBAegBAfgBAogCAagCA7gCx_7q_AXAAgHSAiQ3ZjNmMWU3My0wOTZhLTQ5YjMtOGE0Zi1kZGU2OTAyM2JiMWXYAgXgAgE;sid=12a8b409f259b2760cdf245b9e549b54;tmpl=searchresults;checkin_year_month_monthday=2020-10-31;checkout_year_month_monthday=2020-11-04;class_interval=1;dest_id=-1871728;dest_type=city;group_adults=1;group_children=0;label_click=undef;no_rooms=1;offset=0;raw_dest_type=city;room1=A;sb_price_type=total;shw_aparth=1;slp_r_match=0;srpvid=90a28466542d013c;ss=stuttgart;ss_all=0;ssb=empty;sshis=0;top_ufis=1&;selected_currency=USD
    def start_requests(self):
        yield scrapy.Request(url='''https://www.booking.com/searchresults.html?label=gen173nr-1FCAQoggJCDGNpdHlfLTI5MDI2M0gBWARoQ4gBAZgBAbgBF8gBDNgBAegBAfgBAogCAagCA7gCx_7q_AXAAgHSAiQ3ZjNmMWU3My0wOTZhLTQ5YjMtOGE0Zi1kZGU2OTAyM2JiMWXYAgXgAgE;sid=12a8b409f259b2760cdf245b9e549b54;tmpl=searchresults;checkin_year_month_monthday=2020-10-31;checkout_year_month_monthday=2020-11-04;class_interval=1;dest_type=city;group_adults=1;group_children=0;label_click=undef;no_rooms=1;offset=0;raw_dest_type=city;room1=A;sb_price_type=total;shw_aparth=1;slp_r_match=0;srpvid=90a28466542d013c;ss={0};ss_all=0;ssb=empty;sshis=0;top_ufis=1&;selected_currency=USD'''.format(self.city),
        callback=self.parse, headers=self.header)

        yield scrapy.Request(url='''https://www.expedia.com/Hotel-Search?adults=2&d1=2020-11-01&d2=2020-11-05&destination={0}&endDate=2020-11-05&rooms=1&semdtl=&sort=RECOMMENDED&startDate=2020-11-01&theme=&useRewards=false&userIntent'''.format(self.city),
        callback=self.parse, headers=self.header)
